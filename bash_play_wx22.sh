...
mvsource=2
sheight=$2
subfile="${curdir}/sub/sub22.srt"
config="${curdir}/list/config22.txt"
playlist="${curdir}/list/playlist22.txt"
playlist_done="${curdir}/list/playlist_done22.txt"
ffmpeglog="${curdir}/log/ffmpeg22.log"
news="${curdir}/log/news22.txt"
